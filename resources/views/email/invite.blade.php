                                       ...
                                       <tbody>
                                          <tr>
                                             <td width="169" height="45" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="http://arsene.me">
                                                   <h1 style="color: #0a8">MeetingHub</h1>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="#"><img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="{{ asset('imgs/email.png') }}" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Vous avez été invité par {{ $organisateur->name }}, avec l'adresse suivante :<br>
                                                {{ $mail_participant }}. <br><br>
                                                <a href="#" style="text-decoration:none; color: #0a8cd8; ">See invitation</a>
                                             </td>
                                          </tr>
                                          <!-- End of content -->
                                       </tbody>
                           ...
                           <tbody>
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="postfooter">
                                    MeetingHub <span style="text-decoration: none; color: #0a8">Arsène, Florian & Yassine</span> 
                                 </td>
                              </tr>
                              <!-- Spacing -->
                              <tr>
